function [elevation, azimuth,a,HRA]=alpha_azimuthcalc(LT,d,longitude,latitude)
...
%     azimuth(i)=a(i);
% elseif(HRA(i)>0)
%     azimuth(i) =360-a(i); %% VERY IMP: for some months like june azimuth = -a(1). otherwise time vs az-El graph will not be continuous
%     end
% end
